...
> * Нет необходимости создавать второй зеркально отраженный блок. Для этого необходимо просто нажать кнопку "ProjectFunctional/Regenerate RoadBlocks Mirrors" в верхнем меню Unity.
